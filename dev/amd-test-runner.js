...
console.log('Loading UnderscoreDeep qUnit configurations.');

define(['text!amd-test-config.json','underscore'], function(testConfigString, undef) {

    console.log('Loading UnderscoreDeep qUnit tests.');
    ...
    return require(tests, function() {
        console.log('Initializing UnderscoreDeep qUnit tests.');
